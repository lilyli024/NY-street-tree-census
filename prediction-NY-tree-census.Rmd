...
Comparing optimal parameters with the highest area under the ROC curve
...
We can look at area under the ROC curve to see which model is best to distinguish between classes of tree health. Random forests would be our ideal model and is most capable of distinguishing between classes and providing high accuracy.
